...
const IndividuallyCappedCrowdsaleContract = artifacts.require("IndividuallyCappedCrowdsaleContract");
...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(IndividuallyCappedCrowdsaleContract,   
      ...
      ERC20FixedSupplyInstance.approve(IndividuallyCappedCrowdsaleContract.address, web3.utils.toWei(totalSupply.toString(),'ether'));
    });
  })
};
