...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(ERC20PausableCrowdsale,   
      ...
      ERC20FixedSupplyInstance.approve(ERC20PausableCrowdsale.address, web3.utils.toWei(totalSupply.toString(),'ether'));
    });
  })
};
