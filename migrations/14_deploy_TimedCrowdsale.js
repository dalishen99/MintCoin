...
const TimedCrowdsaleContract = artifacts.require("TimedCrowdsaleContract");
...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(TimedCrowdsaleContract,   
      ...
      ERC20FixedSupplyInstance.approve(TimedCrowdsaleContract.address, web3.utils.toWei(totalSupply.toString(),'ether'));
    });
  })
};
