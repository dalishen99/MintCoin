...
const WhitelistCrowdsaleContract = artifacts.require("WhitelistCrowdsaleContract");
...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(WhitelistCrowdsaleContract,   
      ...
      ERC20FixedSupplyInstance.approve(WhitelistCrowdsaleContract.address, web3.utils.toWei(totalSupply.toString(),'ether'));
    });
  })
};
