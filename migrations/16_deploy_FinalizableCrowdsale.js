...
const FinalizableCrowdsaleContract = artifacts.require("FinalizableCrowdsaleContract");
...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(FinalizableCrowdsaleContract,
      ...
      ERC20FixedSupplyInstance.approve(FinalizableCrowdsaleContract.address, web3.utils.toWei(totalSupply.toString(), 'ether'));
    });
  })
};
