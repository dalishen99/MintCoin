...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(ERC20FinalizableCrowdsale,
      ...
      ERC20FixedSupplyInstance.approve(ERC20FinalizableCrowdsale.address, web3.utils.toWei(totalSupply.toString(), 'ether'));
    });
  })
};
