...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(ERC20PostDeliveryCrowdsale,
      ...
      ERC20FixedSupplyInstance.approve(ERC20PostDeliveryCrowdsale.address, web3.utils.toWei(totalSupply.toString(), 'ether'));
    });
  })
};
