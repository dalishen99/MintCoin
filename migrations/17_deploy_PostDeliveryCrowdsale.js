...
const PostDeliveryCrowdsaleContract = artifacts.require("PostDeliveryCrowdsaleContract");
...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(PostDeliveryCrowdsaleContract,
      ...
      ERC20FixedSupplyInstance.approve(PostDeliveryCrowdsaleContract.address, web3.utils.toWei(totalSupply.toString(), 'ether'));
    });
  })
};
