...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(ERC20RefundableCrowdsale,
      ...
      ERC20FixedSupplyInstance.approve(ERC20RefundableCrowdsale.address, web3.utils.toWei(totalSupply.toString(), 'ether'));
    });
  })
};
