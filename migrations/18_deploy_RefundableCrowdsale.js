...
const RefundableCrowdsaleContract = artifacts.require("RefundableCrowdsaleContract");
...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(RefundableCrowdsaleContract,
      ...
      ERC20FixedSupplyInstance.approve(RefundableCrowdsaleContract.address, web3.utils.toWei(totalSupply.toString(), 'ether'));
    });
  })
};
