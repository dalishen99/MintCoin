...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(AllowanceCrowdsaleContract,   
      ...
      ERC20FixedSupplyInstance.approve(AllowanceCrowdsaleContract.address, web3.utils.toWei(totalSupply.toString(),'ether'));
    });
  })
};
