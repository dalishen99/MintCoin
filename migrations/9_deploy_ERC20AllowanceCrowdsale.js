...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ERC20FixedSupply,
    ...
    return deployer.deploy(ERC20AllowanceCrowdsale,   
      ...
      ERC20FixedSupplyInstance.approve(ERC20AllowanceCrowdsale.address, web3.utils.toWei(totalSupply.toString(),'ether'));
    });
  })
};
